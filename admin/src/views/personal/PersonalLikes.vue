<template>
    <div class="personal-likes" ref="containerRef">
        <!-- 帖子列表 -->
...
import { getMyLikeListApi, getUserLikeListApi, viewPostApi, likePostApi } from '../../api/post.js'
...
const fetchPosts = async () => {
    ...
    try {
        ...
        let res
        if (isOtherUser.value) {
            res = await getUserLikeListApi(otherUserId.value, params)
        } else {
            res = await getMyLikeListApi(params)
        }
